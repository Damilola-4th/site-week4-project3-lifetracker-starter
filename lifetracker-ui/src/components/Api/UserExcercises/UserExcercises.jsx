...
const UserExcercises = ({UserID}) => {
    ...
    const PostUserExcercises = async (ExcerciseLog) => {
        try {
            ...
            const response = await axios.post("https://lifetracker-bk1k.onrender.com/exercise/addexercise", { 'name' :ExcerciseLog.name, 'duration': ExcerciseLog.duration, 'intensity': ExcerciseLog.intensity, 'category': ExcerciseLog.category, 'UserID': UserID });
            console.log(response.data)
