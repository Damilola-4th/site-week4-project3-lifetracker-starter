...
const ActivityPage = ({Login, ExerciseLogs, NutritionLogs, SleepLogs, GetUserNutritionLogs, GetSleepingData,GetUserExcercises, setExcerciseLogs, setNutritionLogs, setSleepLogs }) => {
